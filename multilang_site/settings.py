...
SECRET_KEY = 'django-insecure-8%5@pe4o8dv4f5+enr)h9v3^z&a(8#(36fjxg$v#%7#rye4+1x'
...
MIDDLEWARE = [
    ...
    'django.middleware.common.CommonMiddleware', # Middleware pour la gestion de la langue
